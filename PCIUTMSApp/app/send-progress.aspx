<%@ Page Title="" Language="C#" MasterPageFile="~/root.Master" AutoEventWireup="true" CodeBehind="send-progress.aspx.cs" Inherits="PCIUTMSApp.app.send_progress" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="col-md-12 card card-body">
        ...
        <div class="row mt-3">
            <div class="col-md-12">
                Title:
        <asp:TextBox ID="txtTitle" placeholder="Progress Title" CssClass="form-control" runat="server"></asp:TextBox>
            </div>
            <div class="col-md-12">
                Description:
