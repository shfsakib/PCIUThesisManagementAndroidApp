<%@ Page Title="" Language="C#" MasterPageFile="~/root.Master" AutoEventWireup="true" CodeBehind="coordinator-list.aspx.cs" Inherits="PCIUTMSApp.app.coordinator_list" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Coordinator List</h1>
                </div>
            </div>
        </div>
    </div>
    <div class="col-md-12">
        <div class="row">
            ...
            <div class="col-xs-8 col-lg-4">
                <asp:DropDownList ID="ddlCoordinate" AutoPostBack="True" OnSelectedIndexChanged="ddlCoordinate_OnSelectedIndexChanged" class="form-control select2 wd" runat="server">
                    <asp:ListItem Value="A">--SEARCH Coordinate--</asp:ListItem>
                </asp:DropDownList>
            </div>
        </div>
        <div class="row mt-3">
            <div class="col-lg-12 justify-content-center table-responsive" style="margin-top: 20px">
                <asp:GridView ID="gridCoordinate" Width="100%" class="table table-hover table-bordered table-striped" OnPageIndexChanging="gridCoordinate_OnPageIndexChanging" OnRowDataBound="gridCoordinate_OnRowDataBound" AutoGenerateColumns="False" ShowHeader="True" ShowHeaderWhenEmpty="True" EmptyDataText="No Coordinator Found" AllowPaging="True" PageSize="30" runat="server">
                    <Columns>
